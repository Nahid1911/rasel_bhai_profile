  ...
  let projects = [
    {
      ...
      techStack: ["Bookkeeping", "Bank Reconciliation", "Financial Reporting", "Management Reporting"],
    },
    {
      projectId: 2,
      projectName: "Taxation",
      techStack: ["Corporate Tax Filing", "Individual Tax Filing", "Tax Assessment", "Tax Planning"],
    },
    {
      projectId: 3,
      projectName: "Value Added Tax (VAT)",
      techStack: ["Monthly Return Filing", "Maintain VAT Books", "Handle VAT Cases", "BIN Registration"],
    },
    {
      projectId: 4,
      projectName: "BPO",
      techStack: ["Invoicing", "Payment Processing", "Recording Transactions", "Regulatory Complience"],
    },
    {
      projectId: 5,
